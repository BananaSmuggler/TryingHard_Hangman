...
public class Play extends JPanel implements ActionListener {
    ...
    private int error = 0;
    private StartUp play;

    //Constructor
    public Play(StartUp play) {
        this.play = play;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (button != null) {
            ...
            if (choice.equals("skip")) {
                play.getContentPane().setVisible(false);
                play.getContentPane().remove(this);
                play.add(new EndGame(play, 0));
                play.getContentPane().setVisible(true);
            }
            //Draw head
            ...
            if (win == true) {
                ...
                play.getContentPane().setVisible(false);
                play.getContentPane().remove(this);
                play.add(new EndGame(play, score));
                play.getContentPane().setVisible(true);
            }
